...
java -XX:AOTCacheOutput=${PWD}/cas/cas.aot -Dspring.context.exit=onRefresh -jar casconfigserver/casconfigserver.war

# Run the CAS web application
java -XX:AOTCache=${PWD}/cas/cas.aot -jar casconfigserver/casconfigserver.war
```
